-- ==========================================================
-- IRONCORE GYM MANAGEMENT SYSTEM - SEED DATA
-- ==========================================================
...
-- 1. USERS SEED
-- Passwords:
-- admin@ironcore.com   => admin123
-- trainer@ironcore.com => trainer123 (and all trainers)
-- member@ironcore.com  => member123 (and all members)
...
-- 9. WORKOUT EXERCISES MAPPINGS SEED
...
-- 12. MEMBER DIETS ASSIGNMENTS SEED
...
-- 13. PROGRESS SEED (Historical Weight & Measurements)
...
-- 14. ATTENDANCE SEED (Current & Recent Logs)
